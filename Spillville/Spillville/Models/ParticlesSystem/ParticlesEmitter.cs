...
namespace Spillville.Models.ParticlesSystem
{
    ...
    public class ParticleEmitter
    {
        ...
        //ChemicalsParticlesSystem particleSystem;
        ...
        /// </summary>
        public ParticleEmitter(//ChemicalsParticlesSystem particleSystem,
        ...
        public void Update(GameTime gameTime, Vector3 newPosition)
        {
            ...
            if (elapsedTime > 0)
            {
                ...
                //Vector3 velocity = previousPosition;
                ...
                while (timeToSpend > timeBetweenParticles)
                {
                    ...
                    //newPosition = previousPosition + new Vector3(0, -20, 0);
                    Vector3 position = Vector3.Lerp(previousPosition, newPosition, mu);

                    // Create the particle.
                    //useless ChemicalsParticlesSystem.AddParticle(position, velocity);
                }
