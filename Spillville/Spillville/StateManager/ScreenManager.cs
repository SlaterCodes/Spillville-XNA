...
namespace Spillville.StateManager
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        public GraphicsDeviceManager ManagedGraphicsDevice
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            while (screensToUpdate.Count > 0)
            {
                ...
                if (screen.ScreenState == ScreenTransitionState.TransitionOn ||
                    screen.ScreenState == ScreenTransitionState.Active)
                {
        ...
        public override void Draw(GameTime gameTime)
        {
            foreach (GameScreen screen in screens)
            {
                if (screen.ScreenState == ScreenTransitionState.Hidden)
                    continue;
